                    ...
                    <div className="row d-flex align-items-stretch">
                        <div className="col-6 d-flex flex-column mb-7">
                            <div className="p-4 bg-info custom-border flex-grow-1">
                                ...
                                <p>Firstly, input the protein sequence in the text box (in Fasta format), or upload a Fasta file.</p>
                                <h5 className="pb-2">
                        ...
                        <div className="col-6 d-flex flex-column mb-7">
                            <div className="p-4 bg-light custom-border flex-grow-1">
                                ...
                                <p>Then, choose whether to predict the antibacterial peptide (ABP) activity against a single bacterium.</p>
                                <h5 className="pb-2">
                                    Select type
                                </h5>
                                <div className="row">
                                    {ModalOption.map((option, index) => (
                                        <div className='col-4' key={index}>
                                            <div className={`custom-border custom-hover form-check border-1 py-2 border ${
                        ...
                        <div className="col-6 d-flex flex-column">
                            <div className="p-4 bg-info custom-border flex-grow-1">
                                ...
                                <p>And then click the &quot;Start ANIA&quot; button to execute the prediction task. The specific process is shown in the following diagram.</p>
